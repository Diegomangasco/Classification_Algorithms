...
def main():
    ...
    S = wrapper_logpdf(DTE, class_mean1, covariance_matrix1)
    S = numpy.concatenate((S, wrapper_logpdf(DTE, class_mean2, covariance_matrix2)), axis=1)
    S = numpy.concatenate((S, wrapper_logpdf(DTE, class_mean3, covariance_matrix3)), axis=1)
    S = S.T
...
def main2():
    ...
    S = wrapper_logpdf_with_log_densities(DTE, class_mean1, covariance_matrix1)
    S = numpy.concatenate((S, wrapper_logpdf_with_log_densities(DTE, class_mean2, covariance_matrix2)), axis=1)
    S = numpy.concatenate((S, wrapper_logpdf_with_log_densities(DTE, class_mean3, covariance_matrix3)), axis=1)
    S = S.T
